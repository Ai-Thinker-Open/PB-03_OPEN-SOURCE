...
#define MYRAWPASS_VALUE_HANDLE          2
#define MY_SERVICE_UUID_DEF           0x1513
#define MY_PT_CHAR_UUID_DEF           0x1111
 ...
 */
// MY Service
uint8 bleuart_MYServiceUUID[ATT_BT_UUID_SIZE] =
{
    LO_UINT16(MY_SERVICE_UUID_DEF), HI_UINT16(MY_SERVICE_UUID_DEF)
};
...
// Profile MYService
static gattAttrType_t bleuart_MyService = { ATT_BT_UUID_SIZE, bleuart_ServiceUUID };
...
static gattAttribute_t mybleuart_ProfileAttrTbl[] =
{
    // Simple Profile Service
    {
        { ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */
        GATT_PERMIT_READ,                         /* permissions */
        0,                                        /* handle */
        (uint8*)& bleuart_MyService            /* pValue */
    },
};
...
CONST gattServiceCBs_t mybleuart_ProfileCBs =
{
...
bStatus_t bleuart_MyAddService( bleuart_ProfileChangeCB_t cb)
{
    uint8 status = SUCCESS;
    status = GATTServApp_RegisterService( mybleuart_ProfileAttrTbl,
                                          GATT_NUM_ATTRS( mybleuart_ProfileAttrTbl ),
                                          &bleuart_ProfileCBs );
